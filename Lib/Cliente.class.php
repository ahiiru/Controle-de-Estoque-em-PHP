...
class Cliente extends Banco // detalhes dos clientes
{
	...
	//ao criar uma instancia de cliente, nada vai acontecer porque o banco de dados so conecta quando se cria uma instancia do banco
