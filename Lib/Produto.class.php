...
class Produto extends Banco // detalhes dos produtos
{
	...
	//ao criar uma instancia de produto, nada vai acontecer porque o banco de dados so conecta quando se cria uma instancia do banco
